...
module.exports = async (ctx) => {
    ...
    const spokenLanguage = ctx.params.spokenLanguage || '';
    const url = `https://github.com/trending/${encodeURIComponent(language)}?since=${since}&spoken_language_code=${spokenLanguage}`;
