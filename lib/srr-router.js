...
router.get('/wechat/cimidata/:id', lazyloadRouteHandler('./routes/tencent/wechat/ershcimi'));
...
router.get('/btnull/:cate/:score?', lazyloadRouteHandler('./routes/btnull/btnull'));
