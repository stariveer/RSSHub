...
function toHtmlTable(data) {
    ...
    for (const item of data) {
        html += `<tr><td style="white-space: nowrap; padding: 0 4px 0 0;">${item.model}</td><td style="white-space: nowrap; padding: 0 4px 0 0;">${item.modelDescription}</td><td style="white-space: nowrap; padding: 0 4px 0 0;">${item.capacity}</td><td style="white-space: nowrap; padding: 0 4px 0 0;">${item.version}</td><td style="white-space: nowrap; padding: 0 4px 0 0;">${item.price}</td></tr>`;
    }
    html += '</table>';
    return html;
}
